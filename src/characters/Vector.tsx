export function Vector({ className = "h-16 w-16" }: { className?: string }) {
  return (
    ...
    >
      ...
      <desc id="vector-desc">A geometric character made of coordinate axes and a glowing direction arrow.</desc>
      <defs>
      ...
      />
      {/* Axes */}
      <line x1="40" y1="28" x2="40" y2="52" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <line x1="28" y1="40" x2="52" y2="40" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      {/* Direction arrow (northeast) */}
      <line x1="40" y1="40" x2="54" y2="26" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
