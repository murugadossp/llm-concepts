...
Rather than trying to force the model to memorize the entire universe, we switch the model from a **closed-book exam** to an **open-book exam**:

```
[User Question]
     ↓
[Search DB for docs] ──> Fetch "Yesterday's sales: $42,000"
     ↓
[Build Augmented Prompt]:
"Answer the user question using only this context:
---
Context: Yesterday's sales were $42,000.
---
Question: What were yesterday's sales?"
     ↓
[LLM output] ──> "Yesterday's sales were $42,000."
```
